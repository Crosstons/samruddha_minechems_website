            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <div className="flex items-center">
                  <a
                    href="https://www.linkedin.com/company/samruddha-minechem-private-limited/"
                    aria-label="LinkedIn"
                    target="_blank"
            ...
            {/* <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-3/12">
              <div className="mb-12 lg:mb-16">
                ...
                <ul>
                  ...
                  <li className="mb-4 text-base text-body-color">
                    <span className="font-semibold">Partnerships:</span><br />
                    Ready to partner with us in solving India's phosphate challenge
                  </li>
                  <li className="mb-4 text-base text-body-color">
                    <span className="font-semibold">Business Development:</span><br />
                    Contact our team for business inquiries and more information
                  </li>
                </ul>
              </div>
            </div> */}
