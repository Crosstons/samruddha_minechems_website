            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[800px] text-center">
                ...
                <div className="flex flex-col items-center justify-center space-y-4 sm:flex-row sm:space-x-4 sm:space-y-0">
                  <Link
                    href="/operations"
                    className="rounded-xs bg-primary px-8 py-4 text-base font-semibold text-black duration-300 ease-in-out hover:bg-primary/80"
                  >
                    Explore Operations
                  </Link>
                  <Link
                    href="/products"
                    className="inline-block rounded-xs bg-black px-8 py-4 text-base font-semibold text-white duration-300 ease-in-out hover:bg-black/90"
                  >
                    Our Products
                  </Link>
                  <Link
        ...
        <div className="absolute right-0 top-0 z-[-1] opacity-30 lg:opacity-100">
          ...
          >
            ...
            <defs>
              ...
              >
                <stop offset="0.145833" stopColor="#d1ab7a" stopOpacity="0" />
                <stop offset="1" stopColor="#d1ab7a" stopOpacity="0.08" />
              </radialGradient>
              <radialGradient
          ...
          >
            ...
            <defs>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#d1ab7a" stopOpacity="0" />
                <stop offset="1" stopColor="#d1ab7a" />
              </linearGradient>
              <linearGradient
